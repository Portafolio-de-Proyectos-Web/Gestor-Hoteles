...
const TableReservationAM = () => {
    ...
    const getReservationsByHotel = async () => {
        try {
            const { data } = await axios(`http://localhost:3000/reservation/getRH/${idHotel}`)
    ...
    useEffect(() => { getReservationsByHotel(); getRooms(); getHotels(); }, [])
    ...
    return (
        <>
            ...
            <table className="table table-striped">
                ...
                <tbody>
                    {
                        hotels.map(({ _id, name, direction }, index) => {
